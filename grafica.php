...
<body >
  ...
  <form class="form-horizontal" name="eform" onsubmit="return validateForm()" method="GET" action="procesargrafica.php" >
        <div class="form-group">

           <div class="col-xs-3">Vista 
                <?php
              /*Conexion a la bd*/
              $user=$_SESSION['name'];
              include("conex.php");
          ...
          <select name="vista" class="form-control"  onchange="showUser(this.value)" >
          <option>Seleccione  </option>
          <?php
            while($lista=mysqli_fetch_array($sql))
            echo "<option  value='".$lista[NombreVista]."'>".$lista[NombreVista]."</option>"; 
            ?></select> 
