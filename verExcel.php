  ...
  <div class="container well">
    <?php 
      ...
      if(mysqli_num_rows($sql) == 0 ){
        ...
        echo"<h3>Numero de almacenes <small>($numeroalmacenes)</small></h3>";
        echo"<form class='form-horizontal well' name='mostrarAlmacen' method='POST' action='mostrarAlmacen.php'  enctype='multipart/form-data'>";
        ...
        echo "<table class='table table-striped'>
              ...
              while ($row = mysqli_fetch_array($sql)) {
                echo "<tr><td>".$row[0]."</td><td>".$row[2]."</td><td><input type='radio' name='optAlmacen' checked='checked' value='$row[0]'></td></tr> \n"; 
              }
              echo "<tr> <td></td> <td></td> 
              <td>
                    <button type='submit' name='btn-mostrarAlmacen' class='btn btn-primary'>Mostrar</button>
              </td> </tr>";
              echo "</form>";
