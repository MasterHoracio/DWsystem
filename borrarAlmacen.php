...
<body >
  ...
  <div class="container well">
    <?php 
      ...
      if(mysqli_num_rows($sql) == 0 ){
        ...
        echo"<form class='form-horizontal well' name='bAlmacen' id='bAlmacen' method='POST' action='procesaBorradoAlmacen.php'  enctype='multipart/form-data'>";
  ...
  <script type="text/javascript">
    function confirmBorrado() {
      ...
      var r = confirm("¿Desea borrar el almacen " + select.value + "?");
        if (r == true) {
            form.submit();
        } 
    }
